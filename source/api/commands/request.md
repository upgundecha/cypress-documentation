...
2. If you make a `cy.request()` prior to visiting a page, Cypress prepends the the host configured as the `baseUrl` property inside of of your {% url "configuration file" configuration %}.
